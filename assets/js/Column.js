...
window.store1 = new Ext.data.Store({
    ...
    proxy: {
        type: 'ajax',
        url: 'http://geostation.herokuapp.com/assets/votesinlagos.php',
        reader: {
            root: 'data',
            type: 'json'
        }
    ...
    var chart = Ext.create('Ext.chart.Chart', {
            ...
            axes: [{
                ...
                position: 'bottom',
                fields: ['name'],
                title: 'Metrics Category Parameter'
            }],
            series: [{
                type: 'column',
                axis: 'left',
    ...
    var win = Ext.create('Ext.window.Window', {
        ...
        id: 'chartwin',
        title: 'Chart showing Hypothetical Asset Count per Category',
        autoShow: true,
        layout: 'fit',
        tbar: [{
            text: 'Save Chart',
